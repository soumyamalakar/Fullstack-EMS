    ...
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      <div className="w-full max-w-md animate-fade-in relative z-10">
         ...
         <div className="space-y-4">
          {
            portalOptions.map((portal)=>
              (
                <Link key={portal.to} to={portal.to} className=
                "group block bg-slate-50 border border-slate-200 rounded-lg p-5 sm:p-6 transition-all duration-300 hover:border-indigo-400 hocver:bg-indigo-50">
         ...
         <div className="mt-12 text-center md:text-left text-sm text-slate-400">
          <p>©{new Date().getFullYear()} DevSM. All Rights Reserved</p>
         </div>
      </div>
      </div>
    </div>
